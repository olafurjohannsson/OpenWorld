...
inline typename std::enable_if<
    ...
    typed_value< C, int_type > >::type make_value( const T &val )
{
    return static_cast< int >( val );
}
...
inline typename std::enable_if<
    ...
    typed_value< C, string_type > >::type make_value( const T &val )
{
...
inline typename std::enable_if<
    ...
    typed_value< C, custom_type > >::type make_value( const T &val )
{
    return val;
}
...
private:
    ...
    friend FMT_CONSTEXPR typename internal::result_of< Visitor( int ) >::type visit( Visitor &&vis, const basic_format_arg< Ctx > &arg );
...
typename std::enable_if<
    is_contiguous< Container >::value, std::back_insert_iterator< Container > >::type vformat_to( std::back_insert_iterator< Container > out,
...
inline typename std::enable_if<
    is_contiguous< Container >::value, std::back_insert_iterator< Container > >::type format_to( std::back_insert_iterator< Container > out,
...
inline std::basic_string<
    typename internal::format_string_traits< String >::char_type > format( const String &format_str, const Args & ... args )
{
